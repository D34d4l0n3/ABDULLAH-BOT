...
module.exports = {
SESSION_ID: process.env.SESSION_ID === undefined ? '𝙰𝚂𝙸𝚃𝙷𝙰-𝙼𝙳=b6YSERBC#Ozg1i4e_hI3_4g1RyCJ29cMwIWfLMIUQ1WVJJfFqElY' : process.env.SESSION_ID,
PREFIX: process.env.PREFIX || '.' ,
ALIVE_MSG: process.env.ALIVE_MSG === undefined ? "*Hello , I am active now!!*" : process.env.ALIVE_MSG,
